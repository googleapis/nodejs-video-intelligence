// DO NOT EDIT! This is a generated sample ("LongRunningPromiseAwait",  "video_detect_logo_beta")
'use strict';

// sample-metadata:
//   title:
//   description: Performs asynchronous video annotation for logo recognition on a local file.
//   usage: node samples/v1p3beta1/video_detect_logo_beta.js [--local_file_path "resources/googlework_short.mp4"]
...
const argv = require(`yargs`).option('local_file_path', {
  default: 'resources/googlework_short.mp4',
  string: true,
}).argv;

sampleAnnotateVideo(argv.local_file_path).catch(console.error);
