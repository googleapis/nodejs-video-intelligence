...
describe('v1beta2.VideoIntelligenceServiceClient', () => {
    ...
    describe('annotateVideo', () => {
        it('invokes annotateVideo without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.videointelligence.v1beta2.AnnotateVideoRequest());
        ...
        it('invokes annotateVideo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.annotateVideo(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.videointelligence.v1beta2.IAnnotateVideoResponse, protos.google.cloud.videointelligence.v1beta2.IAnnotateVideoProgress>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.videointelligence.v1beta2.IAnnotateVideoResponse, protos.google.cloud.videointelligence.v1beta2.IAnnotateVideoProgress>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.annotateVideo as SinonStub)
