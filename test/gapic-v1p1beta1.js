...
describe('VideoIntelligenceServiceClient', () => {
  it('has servicePath', () => {
    const servicePath = videoIntelligenceModule.v1p1beta1.VideoIntelligenceServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = videoIntelligenceModule.v1p1beta1.VideoIntelligenceServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port = videoIntelligenceModule.v1p1beta1.VideoIntelligenceServiceClient.port;
    assert(port);
  ...
  it('should create a client with gRPC fallback', () => {
    const client = new videoIntelligenceModule.v1p1beta1.VideoIntelligenceServiceClient({fallback: true});
    assert(client);
  });
