...
describe('v1p1beta1.VideoIntelligenceServiceClient', () => {
    ...
    describe('annotateVideo', () => {
        it('invokes annotateVideo without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.videointelligence.v1p1beta1.AnnotateVideoRequest());
        ...
        it('invokes annotateVideo without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.annotateVideo(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.videointelligence.v1p1beta1.IAnnotateVideoResponse, protos.google.cloud.videointelligence.v1p1beta1.IAnnotateVideoProgress>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.videointelligence.v1p1beta1.IAnnotateVideoResponse, protos.google.cloud.videointelligence.v1p1beta1.IAnnotateVideoProgress>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.annotateVideo as SinonStub)
        ...
        it('invokes annotateVideo with call error', async () => {
            ...
            await assert.rejects(async () => { await client.annotateVideo(request); }, expectedError);
            assert((client.innerApiCalls.annotateVideo as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
