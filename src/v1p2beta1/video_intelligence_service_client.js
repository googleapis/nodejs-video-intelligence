...
class VideoIntelligenceServiceClient {
  ...
  constructor(opts) {
    ...
    const videoIntelligenceServiceStub = gaxGrpc.createStub(
      opts.fallback ?
        protos.lookupService('google.cloud.videointelligence.v1p2beta1.VideoIntelligenceService') :
        protos.google.cloud.videointelligence.v1p2beta1.VideoIntelligenceService,
      opts
    );
