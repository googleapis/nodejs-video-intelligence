...
export class VideoIntelligenceServiceClient {
  ...
  annotateVideo(
      ...
      Promise<[
        LROperation<protosTypes.google.cloud.videointelligence.v1p2beta1.IAnnotateVideoResponse, protosTypes.google.cloud.videointelligence.v1p2beta1.IAnnotateVideoProgress>,
