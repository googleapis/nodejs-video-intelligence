...
export class VideoIntelligenceServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.videoIntelligenceServiceStub = gaxGrpc.createStub(
        opts.fallback ?
          (protos as protobuf.Root).lookupService('google.cloud.videointelligence.v1p1beta1.VideoIntelligenceService') :
          // tslint:disable-next-line no-any
          (protos as any).google.cloud.videointelligence.v1p1beta1.VideoIntelligenceService,
