...
export class VideoIntelligenceServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    if (opts.fallback === 'rest') {
      ...
      lroOptions.httpRules = [{selector: 'google.longrunning.Operations.ListOperations',get: '/v1p3beta1/{name=projects/*/locations/*}/operations',},{selector: 'google.longrunning.Operations.GetOperation',get: '/v1p3beta1/{name=projects/*/locations/*/operations/*}',additional_bindings: [{get: '/v1p3beta1/operations/{name=projects/*/locations/*/operations/*}',}],
      },{selector: 'google.longrunning.Operations.DeleteOperation',delete: '/v1p3beta1/{name=projects/*/locations/*/operations/*}',additional_bindings: [{delete: '/v1p3beta1/operations/{name=projects/*/locations/*/operations/*}',}],
      },{selector: 'google.longrunning.Operations.CancelOperation',post: '/v1p3beta1/{name=projects/*/locations/*/operations/*}:cancel',body: '*',additional_bindings: [{post: '/v1p3beta1/operations/{name=projects/*/locations/*/operations/*}:cancel',}],
      }];
    }
    this.operationsClient = this._gaxModule.lro(lroOptions).operationsClient(opts);
    const annotateVideoResponse = protoFilesRoot.lookup(
      '.google.cloud.videointelligence.v1p3beta1.AnnotateVideoResponse') as gax.protobuf.Type;
    const annotateVideoMetadata = protoFilesRoot.lookup(
      '.google.cloud.videointelligence.v1p3beta1.AnnotateVideoProgress') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.videointelligence.v1p3beta1.VideoIntelligenceService', gapicConfig as gax.ClientConfig,
 ...
 * region_tag:videointelligence_v1p3beta1_generated_VideoIntelligenceService_AnnotateVideo_async
 */
  async checkAnnotateVideoProgress(name: string): Promise<LROperation<protos.google.cloud.videointelligence.v1p3beta1.AnnotateVideoResponse, protos.google.cloud.videointelligence.v1p3beta1.AnnotateVideoProgress>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.videointelligence.v1p3beta1.AnnotateVideoResponse, protos.google.cloud.videointelligence.v1p3beta1.AnnotateVideoProgress>;
  }
