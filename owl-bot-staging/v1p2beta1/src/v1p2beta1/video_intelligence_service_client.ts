...
export class VideoIntelligenceServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const annotateVideoResponse = protoFilesRoot.lookup(
      '.google.cloud.videointelligence.v1p2beta1.AnnotateVideoResponse') as gax.protobuf.Type;
    const annotateVideoMetadata = protoFilesRoot.lookup(
      '.google.cloud.videointelligence.v1p2beta1.AnnotateVideoProgress') as gax.protobuf.Type;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.videointelligence.v1p2beta1.VideoIntelligenceService', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    this.videoIntelligenceServiceStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.videointelligence.v1p2beta1.VideoIntelligenceService') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.videointelligence.v1p2beta1.VideoIntelligenceService,
 ...
 */
  async checkAnnotateVideoProgress(name: string): Promise<LROperation<protos.google.cloud.videointelligence.v1p2beta1.AnnotateVideoResponse, protos.google.cloud.videointelligence.v1p2beta1.AnnotateVideoProgress>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.videointelligence.v1p2beta1.AnnotateVideoResponse, protos.google.cloud.videointelligence.v1p2beta1.AnnotateVideoProgress>;
  }
