...
class VideoIntelligenceServiceClient {
    ...
    constructor(opts) {
        ...
        const defaults = gaxGrpc.constructSettings('google.cloud.videointelligence.v1beta2.VideoIntelligenceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
