...
class VideoIntelligenceServiceClient {
    ...
    constructor(opts) {
        ...
        const defaults = gaxGrpc.constructSettings('google.cloud.videointelligence.v1p3beta1.VideoIntelligenceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
