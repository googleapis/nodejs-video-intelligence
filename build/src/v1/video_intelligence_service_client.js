...
class VideoIntelligenceServiceClient {
    ...
    constructor(opts) {
        ...
        this._descriptors.longrunning = {
            annotateVideo: new gaxModule.LongrunningDescriptor(this.operationsClient, annotateVideoResponse.decode.bind(annotateVideoResponse), annotateVideoMetadata.decode.bind(annotateVideoMetadata)),
        };
        // Put together the default options sent with requests.
        const defaults = gaxGrpc.constructSettings('google.cloud.videointelligence.v1.VideoIntelligenceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
        ...
        this.videoIntelligenceServiceStub = gaxGrpc.createStub(opts.fallback
            ? protos.lookupService('google.cloud.videointelligence.v1.VideoIntelligenceService')
            : // tslint:disable-next-line no-any
                protos.google.cloud.videointelligence.v1
                    .VideoIntelligenceService, opts);
        ...
        for (const methodName of videoIntelligenceServiceStubMethods) {
            const innerCallPromise = this.videoIntelligenceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
