...
mocha_1.describe('v1.VideoIntelligenceServiceClient', () => {
    mocha_1.it('has servicePath', () => {
        const servicePath = videointelligenceserviceModule.v1.VideoIntelligenceServiceClient
            .servicePath;
        assert(servicePath);
    });
    mocha_1.it('has apiEndpoint', () => {
        const apiEndpoint = videointelligenceserviceModule.v1.VideoIntelligenceServiceClient
            .apiEndpoint;
        assert(apiEndpoint);
    });
    mocha_1.it('has port', () => {
...
//# sourceMappingURL=gapic-video_intelligence_service-v1.js.map